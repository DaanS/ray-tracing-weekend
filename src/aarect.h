...
struct xy_rect : public hittable {
    ...
    virtual bool equals(hittable const& rhs) const override {
        ...
        return x0 == that.x0 && x1 == that.x1 && y0 == that.y0 && y1 == that.y1 && k == that.k;
    }
};
...
struct yz_rect : public hittable {
    ...
    virtual bool equals(hittable const& rhs) const override {
        if (typeid(*this) != typeid(rhs)) return false;
        auto that = static_cast<decltype(*this)>(rhs);
        return y0 == that.y0 && y1 == that.y1 && z0 == that.z0 && z1 == that.z1 && k == that.k;
    }
